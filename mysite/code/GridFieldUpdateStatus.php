 ...
 */
class GridFieldUpdateStatus implements GridField_HTMLProvider, GridField_ActionProvider, GridField_URLHandler
{
    ...
    public function getHTMLFragments($gridField){
		...
		$dropdownField = new DropdownField(
			'Status', 
			false, 
			singleton('Prospect')->dbObject('Status')->enumValues()
		);
		$dropdownField->setEmptyString('(Select a status)');
